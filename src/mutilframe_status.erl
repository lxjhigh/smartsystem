%% @author liuheliang
%% @doc @todo Add description to mutilframe_status.


-module(mutilframe_status).
...
%%===========================================================================
handle_info({reply,16#7F,?TYPE,<<_Frameindex:16,Framecount:16,_Num:8,_Other/binary>>},info,{#static_data{token=Token,client=Client,mac=Mac,ip=Desthost,port=Destport}=Static,Dynamic}) ->
	...
	%%【状态跳跃】
    {next_state,data,{Static,Dynamic#dynamic_data{bindex=1,eindex=Framecount,recdata=[],sendata=Dataframe,time=NewTime,num=1,totalength=0}}};
                          ...
                          true->
                                   ...
                                   case Frameindex >= Eindex of
                                                         true->
                                                               ...
                                                               Path = Rootpath ++ "/down/status_" ++ integer_to_list(Mac) ++ ".bin",
