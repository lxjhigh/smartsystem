%% @author liuheliang
%% @doc @todo Add description to mutilframe_version.


-module(mutilframe_version).
...
%%处理配置数据帧
%%数据类型2
handle_info({reply,16#7F,?TYPE,<<Arkindex:16,Framedata/binary>>},data,{Static,Dynamic})->
...
form_info_frame(Client,Token,Mac,Framecount,Framelength,Crc)->
	...
	Data = <<0:16,0:16,0:8,Framecount:16,0:32,0:8,Framelength:32,Crc:32>>,
